 ...
 */
public class Virus extends FlyingEnemy
{
    ...
    public Virus(int bytes)
    {
        ...
        speed = 5;
        attackFrame = 6;
        loadAnimationFrames("images/Enemies/virus");
    }
    /**
    ...
    public void act()
    {
        ...
        if(health < 10 && !hasDuplicated && !isAttacking)
        {
            duplicate();
            super.act();
            return;
    ...
    public void spawn()
    {
        if(spawnIndex < 4)
        {
            spawnIndex = animate(spawnAnim, spawnIndex);
        }
        else
        {
            isSpawning = false;
    ...
    {
        if(duplicateIndex < 10)
        {
            duplicateIndex = animate(dupAnim, duplicateIndex);
        }
        else
        {
    ...
    public void loadAnimationFrames(String path)
    {
        ...
        loadSingleAnimation(path, dupAnim, "duplicate");
        loadSingleAnimation(path, spawnAnim, "spawn");
    }
